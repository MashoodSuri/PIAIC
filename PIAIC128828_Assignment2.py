...
# %load "Assignment2_NumpyBasicsToAdvance"
...
def function2():
    ...
    x = l=np.arange(9,36).reshape(3,3,3)
    x=x+1
...
def function8():
    ...
    x = np.arange(2*5) #write your code here
    x[0:10]=6
    return x
...
def function9():
    ...
    a = x=np.arange(2,101) # write your code here
...
def function14():
    ...
    ans = arr = np.arange(10, 34, 1).reshape(4,2,3) #write your code here 
...
def function15():
    ...
    ans = ans = arr[arr[:,1].argsort()]  #write your code here 
...
def function17():
    ...
    arr = (np.where((arr%3==0) & (arr%5==0),"YES","NO"))           # Write Your Code HERE
    return arr
    #Excpected Out
    """
